...
with tab2:
    st.subheader("📍 Detalhamento da População (Página 7)")
    ...
    n_lid_extra = c2.number_input("Outros Líderes Próprios", value=0)
    n_sec = c3.number_input("Equipe Segurança", value=0)
    n_oper = c1.number_input("Colab. não líderes (Operacional)", value=0)
